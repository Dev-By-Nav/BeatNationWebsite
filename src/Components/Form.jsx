...
function Form() {
  ...
  return (
    <div className='my-16'>
      <h1 className="flex text-2xl font-semibold items-center justify-center font-montserrat mx-4 text-bn-gold">Get In Touch For Bookings/ Enquiries</h1>
      <h2 className="flex text-lg font-base items-center justify-center mb-8 mt-1 font-raleway mx-4 text-bn-gold">Send us a message to book or for more info.</h2>
